...
namespace poorlord
{
    public class PlayerTileSickle01 : PlayerTile
    {
        private readonly CardValue TILE_VALUE = CardValue.Legend;
        private readonly string TILE_NAME = "SK BLOCK 1";
        ...
        public override List<Vector3Int> CheckTile
        {
            get
            {
                ...
                checkTile.Add(new Vector3Int(2, 0, 0));
                checkTile.Add(new Vector3Int(3, 0, 0));
                checkTile.Add(new Vector3Int(3, 0, 1));
        ...
        public sealed override void Dispose()
        {
            ...
            FieldObjectManager.Instance.ReleaseTile(BlockID.PlayerTileSickle01, this);
        }
