...
namespace poorlord
{
    public class PlayerTileSickle02 : PlayerTile
    {
        private readonly CardValue TILE_VALUE = CardValue.Legend;
        private readonly string TILE_NAME = "SK BLOCK 2";
        ...
        public sealed override void Dispose()
        {
            ...
            FieldObjectManager.Instance.ReleaseTile(BlockID.PlayerTileSickle02, this);
        }
