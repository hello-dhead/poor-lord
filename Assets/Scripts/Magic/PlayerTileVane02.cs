...
namespace poorlord
{
    public class PlayerTileVane02 : PlayerTile
    {
        private readonly CardValue TILE_VALUE = CardValue.Gold;
        private readonly string TILE_NAME = "VA BLOCK 2";
        ...
        public sealed override void Dispose()
        {
            ...
            FieldObjectManager.Instance.ReleaseTile(BlockID.PlayerTileVane02, this);
        }
