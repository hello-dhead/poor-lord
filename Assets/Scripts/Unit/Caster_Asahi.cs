...
namespace poorlord
{
    public sealed class Caster_Asahi : PlayerUnit
    {
        ...
        /// 유닛명
        /// </summary>
        private readonly string UNIT_NAME = "Asahi";
        ...
        private IEnumerator AttackRoutine()
        {
            ...
            if(HP > 0)
            {
                Asahi_Spell spell = PoolManager.Instance.GetOrCreateObjectPoolFromPath<Asahi_Spell>("Prefabs/Asahi_Spell");
